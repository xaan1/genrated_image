import { ServerConfiguration, createConfiguration, ApplicationApi, EndpointApi, IntegrationApi, MessageApi, AuthenticationApi, MessageAttemptApi, EventTypeApi, BackgroundTasksApi, StatisticsApi, WebhookEndpointApi, } from "./openapi/index";
...
class Application {
    ...
    list(options) {
        ...
        return this.api.v1ApplicationList(Object.assign(Object.assign({}, options), { iterator }));
    }
...
class Endpoint {
    ...
    list(appId, options) {
        var _a;
        const iterator = (_a = options === null || options === void 0 ? void 0 : options.iterator) !== null && _a !== void 0 ? _a : undefined;
        return this.api.v1EndpointList(Object.assign(Object.assign({ appId }, options), { iterator }));
    }
...
class EventType {
    ...
    list(options) {
        var _a;
        const iterator = (_a = options === null || options === void 0 ? void 0 : options.iterator) !== null && _a !== void 0 ? _a : undefined;
        return this.api.v1EventTypeList(Object.assign(Object.assign({}, options), { iterator }));
    }
    get(eventTypeName) {
...
class Integration {
    ...
    list(appId, options) {
        var _a;
        const iterator = (_a = options === null || options === void 0 ? void 0 : options.iterator) !== null && _a !== void 0 ? _a : undefined;
        return this.api.v1IntegrationList(Object.assign(Object.assign({ appId }, options), { iterator }));
    }
...
export function messageInRaw(eventType, payload, contentType) {
...
class MessageAttempt {
    ...
    listAttemptsForEndpoint(appId, msgId, endpointId, options) {
        var _a, _b, _c;
        return this.api.v1MessageAttemptListByEndpointDeprecated(Object.assign(Object.assign({ appId,
            msgId,
            endpointId }, options), { iterator: (_a = options === null || options === void 0 ? void 0 : options.iterator) !== null && _a !== void 0 ? _a : undefined, before: (_b = options === null || options === void 0 ? void 0 : options.before) !== null && _b !== void 0 ? _b : undefined, after: (_c = options === null || options === void 0 ? void 0 : options.after) !== null && _c !== void 0 ? _c : undefined }));
    }
