    ...
    v1AuthenticationCreateMessageToken(appId, createMessageTokenIn, idempotencyKey, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (createMessageTokenIn === null || createMessageTokenIn === undefined) {
                throw new RequiredError("AuthenticationApi", "v1AuthenticationCreateMessageToken", "createMessageTokenIn");
            }
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer.stringify(ObjectSerializer.serialize(createMessageTokenIn, "CreateMessageTokenIn", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["HTTPBearer"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
